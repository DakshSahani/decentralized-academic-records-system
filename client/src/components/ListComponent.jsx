...
export default function ListComponent({heading, id, to,add, ...other}) {
  return (
    <Link
        className={`w-full p-2 mb-4 border flex ${add?"bg-[#2563eb] justify-center":"border-gray-500 justify-between"} rounded-2xl items-center hover:cursor-pointer transform transition-transform duration-300 hover:scale-[1.03]`}
        to={to}
        {...other}
    >
